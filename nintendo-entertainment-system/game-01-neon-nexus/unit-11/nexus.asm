;──────────────────────────────────────────────────────────────
; NEON NEXUS - Unit 11 sample (SFX)
; Builds on Unit 10: state machine, HUD, lives, player movement,
; simple sound engine. Adds two SFX: HIT (noise) and PICKUP (pulse).
; Buttons: B triggers HIT, A triggers PICKUP for testing.
;──────────────────────────────────────────────────────────────
...
;------------------------------------------------------------
; APU Sound (pulse + noise SFX)
;------------------------------------------------------------
.proc apu_init
    lda #%00010001        ; enable pulse1 + noise
    sta APU_CTRL
