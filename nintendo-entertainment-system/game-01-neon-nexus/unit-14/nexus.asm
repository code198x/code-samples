;──────────────────────────────────────────────────────────────
; NEON NEXUS - Unit 14 sample (High Score)
; Builds on Unit 13 title/music/SFX. Adds session high score storage,
; renders the best score on the title and game-over screens, and updates
; it when you beat your last run.
;──────────────────────────────────────────────────────────────
