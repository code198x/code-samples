...
buttons:          .res 1
buttons_prev:     .res 1
buttons2:         .res 1  ; NEW - Player 2 controller
buttons2_prev:    .res 1  ; NEW
paddle_y:         .res 1
paddle_y_old:     .res 1
paddle2_y:        .res 1  ; NEW - Player 2 paddle position
paddle2_y_old:    .res 1  ; NEW
ball_x:           .res 1
ball_y:           .res 1
ball_dx:          .res 1
ball_dy:          .res 1
...
PADDLE_SPEED = 3
PADDLE1_X = 16
PADDLE2_X = 232          ; NEW - Right side of screen
PADDLE_WIDTH = 8
PADDLE_HEIGHT = 32
BALL_SIZE = 8
BALL_START_X = 128
...
:   BIT $2002
    ...
    LDX #$20             ; Skip more sprites for player 2 paddle
    LDA #$FF
:   STA $0200,X
    INX
    INX
...
UpdatePlaying:
    JSR UpdatePaddle
    JSR UpdatePaddle2    ; NEW
    JSR UpdateBall
    JSR CheckScoring
    JSR UpdateCollisionTimer
    JSR CheckPaddleCollision
    JSR CheckPaddle2Collision  ; NEW
...
CheckPaddle2Collision:
    ...
    ; Check X overlap (ball right edge with paddle left edge)
    LDA ball_x
    CLC
    ADC #BALL_SIZE
    CMP #PADDLE2_X
...
;===============================================================================
; ReadController2 - Read controller 2 from $4017
;===============================================================================
ReadController2:
    LDA buttons2
    STA buttons2_prev
    ; Strobe already done in ReadController
    LDX #$08
:   LDA $4017
    LSR
    ROL buttons2
...
@paddle2_loop:
    ...
    LDA #$00
    STA $0201,X
    LDA #%00000010      ; Different palette
    STA $0202,X
    LDA #PADDLE2_X
    STA $0203,X
    INX
