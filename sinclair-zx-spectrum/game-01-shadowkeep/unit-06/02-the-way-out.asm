; ============================================================================
; SHADOWKEEP — Unit 6, Stage 2: The Way Out
; ============================================================================
; A way out needs to exist before it can do anything. This stage adds the
; EXIT cell type — PAPER 4 (green), INK 0 — and places one in the
; antechamber's east wall, opposite the door the thief comes in through.
;
; The collision check picks up its fourth walkable case: EXIT joins FLOOR,
; GOLD, and DOOR_OPEN in the allow list. The thief can walk onto the exit
; cell and stand there. No win state yet — Stage 3 will turn that step
; into the trigger that ends the game.
;
; For the screenshot we boot directly into the antechamber (`START_ROOM
; equ 1`) so the exit is visible without crossing through the door first.
; Change `START_ROOM` to `0` and the game starts in the great hall as
; normal.
; ============================================================================
...
START_ROOM     equ 1                            ; antechamber, for the demo
...
; ----------------------------------------------------------------------------
; Room 1: Antechamber — now with an EXIT cell on the east wall at row 8
; ----------------------------------------------------------------------------
