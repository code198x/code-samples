5 REM === CIRCULAR LAYOUTS WITH SIN/COS ===
10 BORDER 0: PAPER 0: INK 7: CLS
20 DIM x(14): DIM y(14)
25 DIM f(14): DIM g(14)
26 DIM u(20)
27 REM SIN and COS place nodes in a circle.
28 REM angle = 2*PI*i/nn distributes evenly.
30 LET nn = 6: LET nc = 5
35 LET cx = 128: LET cy = 88: LET rd = 60
40 FOR i = 1 TO nn
45 LET ag = 2 * PI * i / nn
50 LET x(i) = INT (cx + rd * COS ag)
55 LET y(i) = INT (cy + rd * SIN ag)
60 NEXT i
65 REM Connections
70 READ nc
75 FOR i = 1 TO nc: READ f(i), g(i): NEXT i
80 LET cn = 1: LET s1 = 0: LET dn = 0
85 LET up = 0: LET uc = 0: LET rc = 0
90 LET sc = 0
100 GO SUB 400
105 GO SUB 450
110 GO SUB 500
...
852 GO SUB 500
855 IF dn = nc THEN PRINT AT 20, 0; INK 7; BRIGHT 1; "PUZZLE COMPLETE!               ": BEEP 0.1, 12: BEEP 0.1, 16: BEEP 0.2, 19: STOP
860 RETURN
1200 REM === undo ===
...
1255 GO SUB 500
1260 RETURN
1500 REM === CONNECTION DATA ===
1510 DATA 5
1520 DATA 1,2, 2,3, 3,4, 5,6, 1,6
