...
405 FOR a = 1 TO nn
410 LET i = 7
412 REM Check if node is fully connected
...
421 NEXT j
422 IF nc2 > 0 AND dc2 = nc2 THEN LET i = 4: IF pz > 3 THEN LET i = 5
425 GO SUB 300
430 NEXT a
435 RETURN
450 REM === draw cursor ===
...
496 IF tg > 0 THEN LET a = tg: LET i2 = 3: CIRCLE INK 3; x(a), y(a), 5
498 NEXT i
499 RETURN
500 REM === draw HUD ===
