5 REM === NODE STATE COLOURS ===
10 BORDER 0: PAPER 0: INK 7: CLS
20 DIM x(14): DIM y(14)
25 DIM f(14): DIM g(14)
26 DIM u(20)
27 DIM c(14)
28 REM c() tracks connections per node
...
107 REM Count required connections per node
108 FOR i = 1 TO nn: LET c(i) = 0: NEXT i
109 FOR i = 1 TO nc: LET c(f(i)) = c(f(i)) + 1: LET c(g(i)) = c(g(i)) + 1: NEXT i
...
315 RETURN
400 REM === draw all nodes with state colour ===
405 FOR a = 1 TO nn
410 GO SUB 430
415 GO SUB 300
420 NEXT a
425 RETURN
430 REM determine node colour
432 REM Count how many drawn lines include node a
434 LET nd = 0
436 FOR j = 1 TO up
...
1242 REM Redraw nodes with updated state
