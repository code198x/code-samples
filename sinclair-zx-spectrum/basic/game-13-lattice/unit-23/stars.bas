...
897 LET rc = rc + 1
899 RETURN
900 REM === puzzle complete with stars ===
...
924 PRINT AT 19, 0; INK 7;
926 IF st = 1 THEN PRINT "  * complete"
928 IF st = 2 THEN PRINT " ** no undo used"
929 IF st = 3 THEN PRINT "*** clean solve!"
