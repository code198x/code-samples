...
897 LET rc = rc + 1
899 RETURN
900 REM === puzzle complete with star rating ===
...
925 REM Display star explanation
927 IF st = 1 THEN PRINT AT 19, 18; INK 6; "complete"
928 IF st = 2 THEN PRINT AT 19, 18; INK 6; "no undo!"
929 IF st = 3 THEN PRINT AT 19, 16; INK 6; "clean solve!"
...
1510 DATA 5
1515 DATA 50,120, 128,120, 206,120, 90,60, 166,60
1520 DATA 4
1525 DATA 1,2, 2,3, 4,5, 1,4
1530 DATA 5
1535 DATA 50,120, 128,140, 206,120, 90,60, 166,60
1540 DATA 5
1545 DATA 1,2, 2,3, 4,5, 1,4, 3,5
1550 DATA 6
1555 DATA 50,130, 128,130, 206,130, 50,60, 128,60, 206,60
1560 DATA 6
1565 DATA 1,2, 2,3, 4,5, 5,6, 1,4, 3,6
