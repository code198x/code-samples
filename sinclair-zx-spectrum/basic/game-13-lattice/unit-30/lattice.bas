...
2055 PRINT AT 19, 2; INK 7; "or Q to quit"
...
2085 CLS
2090 PRINT AT 8, 8; INK 7; BRIGHT 1; "THANKS FOR PLAYING"
2092 PRINT AT 10, 8; INK 6; "Final score: "; sc
2094 PRINT AT 12, 2; INK 7; "Stars earned:"
2096 FOR i = 1 TO tp
2097 PRINT AT 13 + i, 4; "Puzzle "; i; ": ";
2098 IF s(i) = 0 THEN PRINT "-";
2099 IF s(i) > 0 THEN FOR j = 1 TO s(i): PRINT INK 6; "*";: NEXT j
2100 NEXT i
2105 PAUSE 0
2110 STOP
