...
100 READ f(i), g(i)
110 NEXT i
120 LET cn = 1: LET s1 = 0: LET dn = 0: LET up = 0
130 GO SUB 400
135 GO SUB 450
137 GO SUB 500
140 REM === input loop ===
...
750 NEXT j
755 REM check crossing via ATTR
760 LET cx = 0
...
815 NEXT j
820 IF cx = 1 THEN PRINT AT 20, 0; INK 2; "Lines would cross!             ": BEEP 0.1, -10: RETURN
...
852 GO SUB 500
855 IF dn = nc THEN PRINT AT 20, 0; INK 7; BRIGHT 1; "PUZZLE COMPLETE!               ": STOP
860 RETURN
1500 REM === PUZZLE DATA ===
1505 REM 5 nodes, 4 connections
1510 DATA 5
