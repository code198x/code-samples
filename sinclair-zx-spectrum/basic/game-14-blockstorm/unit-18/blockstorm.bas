...
36 NEXT i
38 REM row 2: 2 scouts, 1 tank, 2 drones
...
48 LET e(10) = 8: LET r(10) = 1: LET t(10) = 2: LET h(10) = 1
...
384 LET d(1) = 0
386 LET h(ht) = h(ht) - 1
388 IF h(ht) <= 0 THEN GO TO 510
390 REM damage flash for multi-hit enemies
