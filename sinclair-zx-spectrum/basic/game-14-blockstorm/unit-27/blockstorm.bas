...
72 GO SUB 600
75 GO SUB 500
76 REM measure loop time
77 LET ft = PEEK 23672
80 REM === game loop ===
85 LET k$ = INKEY$
...
125 GO SUB 550
130 GO SUB 600
132 REM timing: show frames per loop
133 LET nt = PEEK 23672
134 LET dt = nt - ft: IF dt < 0 THEN LET dt = dt + 256
135 PRINT AT 21, 0; INK 6; "T:"; dt; " "
136 LET ft = nt
137 GO SUB 650
140 GO TO 80
300 REM === move left ===
