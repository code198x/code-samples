"""Enter readable Tail Chase listings through the Spectrum's ROM keyboard editor."""
...
class Spectrum(module.Spectrum):
    ...
    def statement(self, line):
        normal = {'PRINT': 'p', 'LET': 'l', 'RUN': 'r', 'SAVE': 's',
                  ...
                  'FOR': 'f', 'NEXT': 'n', 'DIM': 'd', 'RANDOMIZE': 't', 'POKE': 'o'}
        symbol = {'THEN': 'g', '<>': 'w', 'STOP': 'a', 'AT': 'i',
                  'TO': 'f', 'AND': 'y', 'OR': 'u'}
        extended = {'LEN': 'k', 'VAL': 'j', 'STR$': 'y', 'INT': 'r', 'ABS': 'g', 'RND': 't', 'INKEY$': 'n', 'USR': 'l', 'CHR$': 'u', 'PEEK': 'o', 'DATA': 'd', 'READ': 'a', 'RESTORE': 's'}
