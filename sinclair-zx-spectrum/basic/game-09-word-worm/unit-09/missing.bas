...
130 LET p = 1: LET b$ = ""
140 PRINT AT 0, 0; "Score: "; e; "  Misses: "; m; "/3  "
150 REM game loop
160 LET t = t + 1
...
190 LET r = r + 1
200 LET t = 0
210 IF r >= 20 THEN GO TO 350
220 PRINT AT r, 12; INK 6; a$
230 LET k$ = INKEY$
...
450 REM game over
460 CLS
470 PRINT AT 8, 9; INK 2; "GAME OVER"
480 PRINT AT 10, 8; "Score: "; e
490 STOP
