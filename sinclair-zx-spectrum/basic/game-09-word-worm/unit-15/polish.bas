...
150 GO SUB 600
160 IF r >= 19 THEN GO SUB 700: GO TO 110
170 LET t = 0
...
582 IF j >= 5 THEN LET e = e + 5: PRINT AT 10, 9; INK 3; BRIGHT 1; "STREAK! +5": BEEP 0.05, 20: BEEP 0.05, 24: BEEP 0.1, 28: PAUSE 10: PRINT AT 10, 9; "          ": LET j = 0
584 IF c >= 10 THEN LET v = v + 1: LET c = 0: LET s = s - 5: IF s < 5 THEN LET s = 5: BORDER v
586 GO SUB 900
588 GO SUB 800
590 RETURN
600 REM === move word ===
...
992 BEEP 0.15, 0: BEEP 0.15, -3: BEEP 0.2, -7
995 STOP
