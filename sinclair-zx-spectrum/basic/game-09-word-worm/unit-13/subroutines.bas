...
560 REM word complete
570 PRINT AT r, 12; "       "
580 LET e = e + 1: LET c = c + 1
590 BEEP 0.1, 15
592 IF c >= 10 THEN LET v = v + 1: LET c = 0: LET s = s - 5: IF s < 5 THEN LET s = 5
594 GO SUB 900
596 GO SUB 800
598 RETURN
600 REM === move word ===
...
790 RETURN
800 REM === draw HUD ===
810 PRINT AT 0, 0; INK 7; "Score:"; e; " Lv:"; v; " Miss:"; m; "/3  "
