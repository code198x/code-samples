...
102 REM place monsters
104 LET t = INT (RND * 3) + 2
106 IF t > 5 THEN LET t = 5
108 LET m = t
110 FOR i = 1 TO m
112 GO SUB 1600
114 LET j(i) = t: LET k(i) = t2
116 LET l(i) = 1: LET n(i) = 4
118 NEXT i
120 GO SUB 380
122 CLS
124 GO SUB 300
126 GO SUB 500
128 REM === main loop ===
130 PAUSE 0: LET i$ = INKEY$
132 LET t = x: LET t2 = y
134 IF i$ = "q" OR i$ = "Q" THEN LET t2 = y - 1
136 IF i$ = "a" OR i$ = "A" THEN LET t2 = y + 1
138 IF i$ = "o" OR i$ = "O" THEN LET t = x - 1
140 IF i$ = "p" OR i$ = "P" THEN LET t = x + 1
142 IF t = x AND t2 = y THEN GO TO 128
144 IF t < 1 OR t > 16 OR t2 < 1 OR t2 > 16 THEN GO TO 128
146 IF d(t2,t) = 1 THEN GO TO 128
148 LET x = t: LET y = t2
150 REM check stairs
152 IF d(y,x) = 2 THEN GO SUB 600: GO TO 128
154 GO SUB 380
156 GO SUB 300
158 GO SUB 500
160 GO TO 128
