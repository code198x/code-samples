...
134 LET d(t2,t) = 3
136 NEXT i
137 REM place fountain (50% chance)
138 IF RND > 0.5 THEN GO SUB 1600: LET d(t2,t) = 4
146 GO SUB 380
148 CLS
150 GO SUB 300
152 GO SUB 500
...
856 PAUSE 20
858 GO TO 820
870 IF RND > 0.5 THEN PRINT AT 8, 0; INK 6; "You escape!      ": PAUSE 20: CLS: RETURN
...
896 PRINT AT 14, 0; INK 6; "Gained "; t4; " gold"
898 IF i5 >= 3 AND RND > 0.5 THEN LET t = INT (e / 3) + 1: IF t > w THEN LET w = t: PRINT AT 16, 0; INK 7; "Dropped a weapon! +"; w
900 PAUSE 30
902 CLS
904 RETURN
1000 REM === death ===
