...
820 REM combat loop
822 PRINT AT 5, 0; INK 7; "A)ttack"
824 PAUSE 0: LET i$ = INKEY$
826 IF i$ <> "a" AND i$ <> "A" THEN GO TO 824
828 REM player attacks
830 LET c = INT (RND * 6) + 1 + a - t3
832 IF c < 1 THEN LET c = 1
834 LET i4 = i4 - c
836 PRINT AT 8, 0; INK 4; "You hit for "; c; "!    "
838 IF i4 <= 0 THEN GO TO 890
840 REM monster attacks
842 LET c = INT (RND * 6) + 1 + t2 - f
844 IF c < 1 THEN LET c = 1
846 LET h = h - c
848 PRINT AT 10, 0; INK 2; "Enemy hits for "; c; "!    "
850 IF h <= 0 THEN GO TO 1200
852 PRINT AT 2, 0; INK 7; "Your HP: "; h; "  Enemy HP: "; i4; "  "
854 PAUSE 20
856 GO TO 820
...
1108 PAUSE 0
1110 STOP
1200 REM === death (placeholder) ===
1202 CLS
1204 PRINT AT 8, 6; INK 2; BRIGHT 1; "YOU HAVE FALLEN"
1206 PRINT AT 12, 6; INK 7; "Press any key"
1208 PAUSE 0
1210 STOP
