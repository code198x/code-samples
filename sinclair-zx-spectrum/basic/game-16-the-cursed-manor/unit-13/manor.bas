...
14 DIM r$(16,20): DIM d$(16,60)
16 DIM e(16,6): DIM w(16)
18 GO SUB 3000
20 LET w(1) = 1
22 GO SUB 700
30 REM === main loop ===
...
56 IF i$ = "GO UP" OR i$ = "go up" THEN LET y$ = "UP"
58 IF i$ = "GO DOWN" OR i$ = "go down" THEN LET y$ = "DOWN"
60 IF i$ = "LOOK" OR i$ = "look" THEN CLS: GO SUB 700: GO TO 30
62 IF y$ = "" THEN PRINT AT 18, 0; INK 2; "I do not understand that.": GO TO 30
64 GO SUB 300
66 IF INT (RND * 5) = 0 THEN PRINT AT 12, 0; INK 3; "A cat crosses the hallway."
68 GO TO 30
...
320 LET r = n: IF w(r) = 0 THEN LET v = v + 1: LET w(r) = 1
322 BEEP 0.02, 5
324 CLS: GO SUB 700
326 RETURN
