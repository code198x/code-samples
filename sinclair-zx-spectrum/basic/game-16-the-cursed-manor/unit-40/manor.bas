...
282 IF x$ = "HELP" THEN PRINT AT 14, 0; INK 5; "GO GET DROP EXAMINE USE": PRINT AT 15, 0; INK 5; "LIGHT SAY LOOK INVENTORY": RETURN
...
434 RETURN
450 REM === use item ===
452 IF y$ = "KEY" AND q(1) = -1 AND r = 8 THEN LET b = 1: LET e(8,5) = 17: LET a = 1: PRINT AT 14, 0; INK 4; BRIGHT 1; "The tower door unlocks!": LET v = v + 3: BEEP 0.1, 10: BEEP 0.1, 15: RETURN
...
514 RETURN
550 REM === say ===
552 IF y$ = "THORNBURY" AND h = 0 THEN LET h = 1: PRINT AT 14, 0; INK 4; BRIGHT 1; "The name echoes through the manor!": LET v = v + 5: BEEP 0.1, 12: BEEP 0.1, 16: RETURN
554 PRINT AT 18, 0; INK 7; "The word echoes and fades."
556 RETURN
580 REM === light ===
582 IF y$ = "CANDLE" AND q(2) = -1 AND q(3) = -1 AND f = 0 THEN LET f = 1: PRINT AT 14, 0; INK 5; BRIGHT 1; "The candle burns with cold blue fire!": LET v = v + 3: BEEP 0.1, 10: RETURN
