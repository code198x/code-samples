...
214 REM direction shortcuts
216 IF x$ = "N" OR x$ = "n" THEN LET x$ = "GO": LET y$ = "NORTH"
218 IF x$ = "S" OR x$ = "s" THEN LET x$ = "GO": LET y$ = "SOUTH"
220 IF x$ = "E" OR x$ = "e" THEN LET x$ = "GO": LET y$ = "EAST"
222 IF x$ = "W" OR x$ = "w" THEN LET x$ = "GO": LET y$ = "WEST"
224 IF x$ = "U" OR x$ = "u" THEN LET x$ = "GO": LET y$ = "UP"
226 IF x$ = "D" THEN LET x$ = "GO": LET y$ = "DOWN"
228 IF x$ = "L" OR x$ = "l" THEN LET x$ = "LOOK"
230 IF x$ = "I" OR x$ = "i" THEN LET x$ = "INVENTORY"
232 IF x$ = "X" OR x$ = "x" THEN LET x$ = "EXAMINE": LET y$ = y$
...
278 IF x$ = "TALK" THEN GO SUB 600: RETURN
280 IF x$ = "SCORE" THEN PRINT AT 18, 0; INK 6; "Score: "; v: RETURN
282 IF x$ = "HELP" THEN PRINT AT 14, 0; INK 5; "GO GET DROP EXAMINE USE": PRINT AT 15, 0; INK 5; "LIGHT SAY TALK LOOK": PRINT AT 16, 0; INK 5; "INVENTORY SCORE HELP": RETURN
...
454 IF y$ = "AMULET" AND q(4) = -1 AND r = 18 AND f = 1 AND h = 1 THEN GO TO 2000
...
600 REM === talk ===
602 FOR i = 1 TO 5
604 IF o(i) = r AND p(i) = 0 THEN GO TO 610
606 GO TO 620
610 PRINT AT 14, 0; INK 4; g$(i); " speaks to you.": BEEP 0.02, 8: RETURN
620 NEXT i
622 PRINT AT 18, 0; INK 2; "Nobody here to talk to."
624 RETURN
...
908 REM move NPC toward home room
910 IF o(i) = p(i) THEN GO TO 930
912 LET n = INT (RND * 4) + 1
914 IF e(o(i),n) > 0 THEN LET o(i) = e(o(i),n)
916 IF o(i) = r THEN PRINT AT 12, 0; INK 4; g$(i); " arrives."
918 LET u(i) = INT (RND * 3) + 2
930 IF u(i) > 0 THEN LET u(i) = u(i) - 1
932 NEXT i
934 RETURN
2000 REM === break curse ===
2002 CLS
2004 PRINT AT 4, 2; INK 7; BRIGHT 1; "THE CURSE IS BROKEN!"
2006 PRINT AT 6, 0; INK 5; "The amulet blazes with light."
2008 PRINT AT 7, 0; INK 5; "The candle flares blue-white."
2010 PRINT AT 8, 0; INK 5; "The name echoes one final time."
2012 BEEP 0.1, 12: BEEP 0.1, 16: BEEP 0.2, 19: BEEP 0.3, 24
2014 PRINT AT 10, 0; INK 4; "Warmth floods the manor. The"
2016 PRINT AT 11, 0; INK 4; "frozen guests gasp and stir."
2018 LET j = 1: LET v = v + 10
2020 PRINT AT 13, 0; INK 6; "The front door clicks open."
2022 LET e(1,2) = 20
2024 PRINT AT 15, 0; INK 7; "You may now leave the manor."
2026 PRINT AT 17, 0; INK 7; "Final score: "; v
2028 PRINT AT 19, 0; INK 7; "Press any key"
2030 PAUSE 0
2032 STOP
3000 REM === load data ===
3002 RESTORE 3100
...
4000 REM === title screen ===
4010 PRINT AT 3, 5; INK 7; BRIGHT 1; "THE CURSED MANOR"
4020 PRINT AT 6, 2; INK 5; "You arrive at Thornbury Manor"
4025 PRINT AT 7, 2; INK 5; "for an autumn gathering."
4030 PRINT AT 9, 2; INK 5; "Every guest stands frozen."
4035 PRINT AT 10, 2; INK 5; "The door locks behind you."
4040 PRINT AT 12, 2; INK 7; "Explore. Examine. Solve."
4045 PRINT AT 13, 2; INK 7; "Break the curse. Escape."
4050 PRINT AT 15, 2; INK 4; "Commands: N S E W U D"
4055 PRINT AT 16, 2; INK 4; "GET DROP EXAMINE USE"
4060 PRINT AT 17, 2; INK 4; "LOOK INVENTORY SAY LIGHT"
4070 PRINT AT 20, 6; INK 7; "Press any key"
4080 PAUSE 0
4090 CLS
4098 RETURN
