...
18 DIM s$(6,15): DIM c$(11,40): DIM q(6)
20 DIM g$(5,15): DIM o(5): DIM p(5)
22 GO SUB 3000
24 LET w(1) = 1
26 GO SUB 700
30 REM === main loop ===
...
224 NEXT i
226 IF x$ = "TAKE" OR x$ = "GRAB" THEN LET x$ = "GET"
228 IF x$ = "CHECK" OR x$ = "INSPECT" THEN LET x$ = "EXAMINE"
230 IF x$ = "WALK" OR x$ = "MOVE" THEN LET x$ = "GO"
232 IF x$ = "UNLOCK" THEN LET x$ = "USE"
234 IF x$ = "GO" THEN GO SUB 300: RETURN
236 IF x$ = "LOOK" THEN CLS: GO SUB 700: RETURN
238 IF x$ = "GET" THEN GO SUB 350: RETURN
240 IF x$ = "DROP" THEN GO SUB 380: RETURN
242 IF x$ = "EXAMINE" THEN GO SUB 400: RETURN
244 IF x$ = "USE" THEN GO SUB 450: RETURN
246 IF x$ = "INVENTORY" THEN GO SUB 500: RETURN
248 IF x$ = "SCORE" THEN PRINT AT 18, 0; INK 6; "Score: "; v: RETURN
250 IF x$ = "QUIT" THEN PRINT AT 18, 0; INK 7; "Final score: "; v: STOP
252 PRINT AT 18, 0; INK 2; "I do not understand that."
254 RETURN
...
406 NEXT i
408 FOR i = 1 TO 5
410 IF o(i) = r AND p(i) = 1 THEN GO TO 416
412 GO TO 420
416 IF y$ = g$(i) OR y$ = "GUEST" THEN PRINT AT 14, 0; INK 6; c$(i + 6): LET v = v + 2: BEEP 0.05, 15: RETURN
420 NEXT i
422 PRINT AT 18, 0; INK 2; "I cannot see that here."
424 RETURN
450 REM === use item ===
452 PRINT AT 18, 0; INK 2; "Nothing happens."
454 RETURN
500 REM === inventory ===
502 LET n = 0
...
710 NEXT i
712 FOR i = 1 TO 5
714 IF o(i) = r AND p(i) = 1 THEN PRINT AT 8, 0; INK 3; g$(i); " stands frozen here."
716 NEXT i
718 PRINT AT 10, 0; INK 7; "Exits: ";
720 IF e(r,1) <> 0 THEN PRINT "N ";
722 IF e(r,2) <> 0 THEN PRINT "S ";
724 IF e(r,3) <> 0 THEN PRINT "E ";
726 IF e(r,4) <> 0 THEN PRINT "W ";
728 IF e(r,5) <> 0 THEN PRINT "U ";
730 IF e(r,6) <> 0 THEN PRINT "D ";
732 PRINT
734 RETURN
3000 REM === load data ===
3002 RESTORE 3100
