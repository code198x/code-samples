...
3104 DATA "Drawing Room","Firelight flickers on faded wallpaper.",0,1,4,0
3106 DATA "Dining Room","A long table set for dinner.",0,0,5,1
3108 DATA "Kitchen","A half-prepared meal goes cold.",0,3,0,0
3110 DATA "Library","Leather and pipe smoke. Books line every wall.",0,0,0,3
3112 DATA "Conservatory","Moonlight through glass panes. Orchids bloom.",0,5,0,0
