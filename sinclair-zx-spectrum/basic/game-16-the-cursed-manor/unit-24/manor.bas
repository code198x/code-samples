...
712 REM show guests
714 FOR i = 1 TO 5
716 IF o(i) = r AND p(i) = 1 THEN PRINT AT 8, 0; INK 3; g$(i); " stands frozen here."
718 NEXT i
720 PRINT AT 10, 0; INK 7; "Exits: ";
722 IF e(r,1) <> 0 THEN PRINT "N ";
724 IF e(r,2) <> 0 THEN PRINT "S ";
726 IF e(r,3) <> 0 THEN PRINT "E ";
728 IF e(r,4) <> 0 THEN PRINT "W ";
730 IF e(r,5) <> 0 THEN PRINT "U ";
732 IF e(r,6) <> 0 THEN PRINT "D ";
734 PRINT
736 RETURN
3000 REM === load data ===
3002 RESTORE 3100
