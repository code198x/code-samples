...
328 RETURN
350 REM === get item ===
352 REM check carry limit
354 LET n = 0
356 FOR i = 1 TO 6
358 IF q(i) = -1 THEN LET n = n + 1
360 NEXT i
362 IF n >= 4 THEN PRINT AT 18, 0; INK 2; "You are carrying too much.": RETURN
364 FOR i = 1 TO 6
366 IF y$ = s$(i) AND q(i) = r THEN LET q(i) = -1: PRINT AT 18, 0; INK 4; "Taken.": BEEP 0.02, 10: RETURN
368 NEXT i
370 PRINT AT 18, 0; INK 2; "I cannot see that here."
372 RETURN
380 REM === drop item ===
382 FOR i = 1 TO 6
