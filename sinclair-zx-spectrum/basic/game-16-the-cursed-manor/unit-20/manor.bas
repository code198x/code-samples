...
234 IF x$ = "INVENTORY" THEN GO SUB 500: RETURN
236 IF x$ = "SCORE" THEN PRINT AT 18, 0; INK 6; "Score: "; v: RETURN
238 IF x$ = "QUIT" THEN PRINT AT 18, 0; INK 7; "Final score: "; v: STOP
240 PRINT AT 18, 0; INK 2; "I do not understand that."
242 RETURN
