...
1060 PRINT AT 17, 1; INK 7; BRIGHT 1; "Player "; p; " WINS!             "
...
2510 PRINT AT 3, 8; INK 7; BRIGHT 1; "BATTLESHIPS"
2520 PRINT AT 6, 2; INK 6; "Two players. Hidden fleets."
2530 PRINT AT 8, 2; INK 7; "Place 5 ships on a 10x10 grid"
2535 PRINT AT 9, 2; INK 7; "then fire shots to find and"
2540 PRINT AT 10, 2; INK 7; "sink the enemy fleet."
2550 PRINT AT 12, 2; INK 5; "Ships:"
2555 PRINT AT 13, 4; INK 7; "A=Carrier(5)  B=Battle(4)"
2560 PRINT AT 14, 4; INK 7; "C=Destroy(3)  D=Sub(3)"
2565 PRINT AT 15, 4; INK 7; "E=Patrol(2)"
2570 PRINT AT 17, 2; INK 5; "Enter coords like: D7"
2575 PRINT AT 18, 2; INK 5; "Direction: H or V"
