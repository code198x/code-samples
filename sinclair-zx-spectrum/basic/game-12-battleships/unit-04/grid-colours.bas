...
36 DATA 5, 4, 3, 3, 2
40 REM place a test ship and shot for demo
42 LET a(1, 1) = 1: LET a(1, 2) = 1: LET a(1, 3) = 1: LET a(1, 4) = 1: LET a(1, 5) = 1
44 LET d(2, 3) = 2: LET d(3, 4) = 1
46 LET c(2, 3) = 2: LET c(3, 4) = 1
50 LET p = 1
55 GO SUB 500
60 STOP
