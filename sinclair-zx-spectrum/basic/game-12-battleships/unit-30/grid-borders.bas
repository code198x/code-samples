...
337 IF x < 1 OR x > 26 THEN PRINT AT 16, 1; INK 2; "Start with A-J": GO TO 330
...
817 IF x < 1 OR x > 26 THEN PRINT AT 17, 1; INK 2; "Start with A-J": GO TO 810
818 IF LEN m$ = 2 THEN LET y = VAL m$(2)
819 IF LEN m$ > 2 THEN LET y = VAL m$(2 TO LEN m$)
820 IF x < 1 OR x > 10 OR y < 1 OR y > 10 THEN PRINT AT 17, 1; INK 2; "Invalid square": GO TO 810
825 LET f = 0
