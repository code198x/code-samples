...
660 RETURN
700 REM === draw status ===
710 PRINT AT 12, 1; INK 6; BRIGHT 1; "Player "; p
715 PRINT AT 13, 1; INK 7; "Shots: ";
...
811 IF m$ = "" THEN PRINT AT 16, 1; INK 2; "Enter a coordinate": GO TO 810
812 IF LEN m$ < 2 THEN PRINT AT 16, 1; INK 2; "Use format: D7": GO TO 810
815 LET x = CODE m$(1) - 64
816 IF x > 26 THEN LET x = x - 32
817 IF x < 1 OR x > 26 THEN PRINT AT 16, 1; INK 2; "Start with A-J": GO TO 810
...
934 IF h(o, v) = l(v) THEN LET k(o, v) = 1: PRINT AT 18, 1; INK 2; BRIGHT 1; "You sank the "; n$(v); "!": BEEP 0.1, 12: BEEP 0.1, 8: BEEP 0.1, 4
936 GO TO 960
950 REM miss
...
1060 PRINT AT 17, 1; FLASH 1; INK 7; BRIGHT 1; "Player "; p; " WINS!             "
1065 PRINT AT 18, 1; INK 7; "P1: "; s1; " shots  P2: "; s2; " shots"
...
1110 PRINT AT 19, 1; INK 7; "Enemy: ";
1120 FOR n = 1 TO 5
