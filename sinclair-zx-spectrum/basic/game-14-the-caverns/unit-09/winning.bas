  ...
  97 PRINT AT 14, 2; "P:"; pit; " C:"; cr; " T:"; t(1); ","; t(2); ","; t(3)
 100 LET clue = 0
 ...
 111 NEXT i
 112 IF gl = 1 THEN PRINT AT 9, 2; "A faint glint nearby...": LET clue = 1
 ...
 150 FOR i = 1 TO 3
 152 IF rm = t(i) THEN LET t(i) = 0: LET found = found + 1: PRINT AT 12, 2; "You found treasure!": BEEP 0.1, 10: BEEP 0.1, 15: PAUSE 30
 154 NEXT i
 ...
 446 BEEP 0.1, 10: BEEP 0.1, 15: BEEP 0.1, 20: PAUSE 0: STOP
