 ...
 168 IF v = 3 THEN GO TO 180
 169 IF v <> 0 THEN GO TO 150
 172 PRINT AT sr+pr-1, sc+pc-1; PAPER 7; INK 0; " "
 176 LET pr = nr: LET pc = nc
 178 PRINT AT sr+pr-1, sc+pc-1; PAPER 7; INK 4; "P"
 179 GO TO 150
 180 REM --- Push crate ---
 182 LET br = nr + dy: LET bc = nc + dx
 184 LET bv = g(br, bc)
 186 IF bv <> 0 THEN GO TO 150
 187 LET g(br,bc) = 3: PRINT AT sr+br-1, sc+bc-1; PAPER 6; INK 0; " "
 190 PRINT AT sr+pr-1, sc+pc-1; PAPER 7; INK 0; " "
 193 LET g(nr,nc) = 0
 196 LET pr = nr: LET pc = nc
 197 PRINT AT sr+pr-1, sc+pc-1; PAPER 7; INK 4; "P"
 198 GO TO 150
 900 DATA 5,5
 901 DATA "WWWWW"
 902 DATA "W   W"
