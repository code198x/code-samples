 ...
 442 IF guesses <= 10 THEN INK 4: PRINT AT 14, 8; "Expert tracker!": GO TO 480
 444 IF guesses <= 20 THEN INK 5: PRINT AT 14, 10; "Not bad": GO TO 480
 446 INK 6: PRINT AT 14, 8; "Keep searching"
 448 GO TO 480
 450 CLS
 ...
 475 BEEP 0.3, -10
 480 INK 7
 485 PRINT AT 18, 4; "Press any key to play again"
 490 PAUSE 0
 500 GO TO 10
