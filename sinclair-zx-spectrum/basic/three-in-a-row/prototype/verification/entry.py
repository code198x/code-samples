"""Enter readable Three in a Row listings through the Spectrum's ROM keyboard editor."""
...
class Spectrum(module.Spectrum):
    ...
    def statement(self, line):
        normal = {'PAUSE': 'm', 'PRINT': 'p', 'LET': 'l', 'RUN': 'r', 'SAVE': 's',
        ...
        extended = {'CODE': 'i', 'PI': 'm', 'SIN': 'q', 'COS': 'w', 'SQR': 'h', 'LEN': 'k', 'VAL': 'j', 'STR$': 'y', 'INT': 'r', 'ABS': 'g', 'RND': 't', 'INKEY$': 'n', 'USR': 'l', 'CHR$': 'u', 'PEEK': 'o', 'DATA': 'd', 'READ': 'a', 'RESTORE': 's'}
        shifted = {'BRIGHT': 'b', 'PAPER': 'c', 'INK': 'x', 'LINE': '3', 'OVER': 'n'}
