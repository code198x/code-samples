 ...
 512 IF pop <= 0 THEN PRINT AT 7, 4; INK 2; "Your kingdom collapsed.": GO TO 550
 ...
 524 IF pop >= 200 THEN PRINT AT 13, 4; INK 4; "Wise Ruler!": GO TO 550
 526 IF pop >= 150 THEN PRINT AT 13, 4; INK 4; "Prosperity!": GO TO 550
 528 IF pop >= 100 THEN PRINT AT 13, 4; INK 6; "Steady Hand.": GO TO 550
 530 IF pop >= 50 THEN PRINT AT 13, 4; INK 6; "Hard Times.": GO TO 550
