 ...
 160 PRINT AT 2, 2;: INK 4: FOR j = 1 TO INT (pop / 10): PRINT CHR$ 143;: NEXT j: FOR j = INT (pop / 10) + 1 TO 30: PRINT " ";: NEXT j: INK 7
 170 PRINT AT 4, 2; "Grain: "; grain
 180 PRINT AT 5, 2; "Land: "; land; " acres"
 190 LET price = INT (RND * 10) + 17
 200 PRINT AT 6, 2; "Land price: "; price; " grain/acre"
 210 INPUT "Buy(+)/Sell(-) acres: "; trade
 220 IF trade > 0 AND trade * price > grain THEN BEEP 0.1, -5: GO TO 210
 230 IF trade < 0 AND -trade > land THEN BEEP 0.1, -5: GO TO 210
 240 LET land = land + trade: LET grain = grain - trade * price
 250 INPUT "Grain to feed: "; feed
 260 IF feed < 0 OR feed > grain THEN BEEP 0.1, -5: GO TO 250
 270 INPUT "Acres to plant: "; plant
 280 IF plant < 0 OR plant > land THEN BEEP 0.1, -5: GO TO 270
 290 IF plant > grain - feed THEN BEEP 0.1, -5: GO TO 270
 300 IF plant > pop * 10 THEN BEEP 0.1, -5: GO TO 270
 ...
 600 CLS
 610 INVERSE 1: PRINT AT 0, 0; "    *** YEARFALL ***  Year "; yr; "   ": INVERSE 0
 620 PRINT AT 3, 2; "Harvest: "; harvested; " grain"
 630 PRINT AT 4, 2; "("; yield; " grain per acre)"
 640 IF starved > 0 THEN BORDER 2: PRINT AT 6, 2; INK 2; starved; " people starved.": BEEP 0.2, -10: BORDER 0
 650 IF starved = 0 THEN PRINT AT 6, 2; INK 4; "Nobody starved."
 660 IF births > 0 THEN PRINT AT 7, 2; INK 4; births; " newcomers arrived."
 670 IF births = 0 THEN PRINT AT 7, 2; "No newcomers this year."
 680 PRINT AT 9, 2; "Population: "; pop
 690 PRINT AT 10, 2; "Grain: "; grain
 700 PRINT AT 11, 2; "Land: "; land; " acres"
 710 PRINT AT 14, 2; "Press any key for next year"
 720 PAUSE 0
 730 LET yr = yr + 1
