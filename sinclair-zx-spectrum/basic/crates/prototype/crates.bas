...
82 IF room = 2 THEN GO SUB 4000
83 IF room = 3 THEN GO SUB 4300
85 GO SUB 6000
90 LET s$ = "Push the crate onto the target."
100 GO SUB 1000
110 GO SUB 3000
...
580 LET s$ = "Push the crate onto the target."
590 IF left = 0 THEN LET won = 1: LET s$ = "Solved! R replays; Q quits."
600 GO SUB 2500
610 GO TO 110
700 GO TO 110
800 LET room = room + 1
...
3030 RETURN
4000 LET g(3,4) = 0: LET g(4,4) = 0: LET g(5,4) = 0
4010 LET g(3,6) = 1: LET g(4,5) = 1: LET g(4,6) = 1: LET g(5,7) = 1
4020 LET g(5,5) = 3: LET pr = 6: LET pc = 5: RETURN
4300 FOR r = 2 TO 3: FOR c = 2 TO 7: LET g(r,c) = 1: NEXT c: NEXT r
4310 LET g(2,4) = 2: LET g(3,4) = 2: LET g(4,4) = 3
4320 LET pr = 6: LET pc = 4: RETURN
...
5120 RETURN
6000 LET left = 0: FOR r = 1 TO 8: FOR c = 1 TO 8
