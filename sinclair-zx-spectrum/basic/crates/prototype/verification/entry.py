"""Enter readable Crates listings through the Spectrum's ROM keyboard editor."""
...
class Spectrum(module.Spectrum):
    ...
    def statement(self, line):
        ...
        symbol = {'THEN': 'g', '<>': 'w', 'STOP': 'a', 'AT': 'i',
                  'TO': 'f', 'AND': 'y', 'OR': 'u'}
        extended = {'LEN': 'k', 'VAL': 'j', 'STR$': 'y', 'INT': 'r', 'ABS': 'g', 'RND': 't', 'INKEY$': 'n', 'USR': 'l', 'CHR$': 'u', 'DATA': 'd', 'READ': 'a', 'RESTORE': 's'}
