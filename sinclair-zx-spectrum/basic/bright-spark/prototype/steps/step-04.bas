...
140 LET s$="22"
150 PRINT AT 20,0;"WATCH. Hold q to finish."
160 FOR i=1 TO LEN s$
170 LET p=VAL s$(i)
180 GO SUB 900
190 LET k$=INKEY$
200 IF k$="q" THEN GO TO 300
210 NEXT i
220 PRINT AT 20,0;"Release the keys.        "
230 IF INKEY$<>"" THEN GO TO 230
240 PRINT AT 20,0;"YOUR TURN. Try 1-4 or q. "
250 LET k$=INKEY$
260 IF k$="" THEN GO TO 250
270 IF k$="q" THEN GO TO 300
280 PRINT AT 21,0;"Read: ";k$
290 STOP
