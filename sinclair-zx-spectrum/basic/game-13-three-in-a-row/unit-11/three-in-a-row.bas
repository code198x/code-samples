  ...
  25 PRINT AT 8, 5; "You are X. Computer is O."
  30 PRINT AT 10, 5; "Get three in a row to win."
  35 PRINT AT 12, 5; "Pick a position: 1 to 9."
  40 PRINT AT 18, 4; "Press any key to start"
  45 PAUSE 0
  50 RANDOMIZE
  55 DIM b(9)
  60 LET moves = 0
  65 LET wins = 0: LET losses = 0: LET draws = 0
  75 CLS
  85 PRINT AT 0, 7; "*** THREE IN A ROW ***"
  87 PRINT AT 1, 2; "W: "; wins; " L: "; losses; " D: "; draws; "  "
  90 FOR n = 1 TO 9
 ...
 135 GO SUB 200
 140 IF winner = 1 THEN GO TO 400
 145 IF moves = 9 THEN GO TO 430
 150 GO SUB 300
 155 LET b(mv) = 2
 160 LET moves = moves + 1
 165 BEEP 0.05, 5
 170 GO SUB 200
 175 IF winner = 2 THEN GO TO 415
 178 IF moves = 9 THEN GO TO 430
 180 GO TO 75
 ...
 352 NEXT i
 360 RETURN
 400 CLS: PRINT AT 6, 7; "*** THREE IN A ROW ***"
 405 PRINT AT 9, 10; INK 4; "You win!"
 407 LET wins = wins + 1
 410 BEEP 0.1, 10: BEEP 0.1, 15: BEEP 0.1, 20
 412 GO TO 440
 415 CLS: PRINT AT 6, 7; "*** THREE IN A ROW ***"
 420 PRINT AT 9, 8; INK 2; "Computer wins!"
 422 LET losses = losses + 1
 424 BEEP 0.3, -10
 425 GO TO 440
 430 CLS: PRINT AT 6, 7; "*** THREE IN A ROW ***"
 432 PRINT AT 9, 11; INK 6; "Draw!"
 434 LET draws = draws + 1
 436 BEEP 0.1, 5: BEEP 0.1, 5
 440 PRINT AT 12, 2; INK 7; "W: "; wins; " L: "; losses; " D: "; draws
 445 PRINT AT 18, 4; "Press any key to play again"
 450 PAUSE 0
 460 DIM b(9)
 465 LET moves = 0
 470 GO TO 75
