 ...
 250 NEXT i
 260 PRINT AT 9, 0
 270 INK 2: FOR j = 1 TO t1: PRINT "*";: NEXT j: PRINT
 280 INK 6: FOR j = 1 TO t2: PRINT "*";: NEXT j: PRINT
 290 INK 4: FOR j = 1 TO t3: PRINT "*";: NEXT j: PRINT
 300 INK 5: FOR j = 1 TO t4: PRINT "*";: NEXT j: PRINT
 310 INK 3: FOR j = 1 TO t5: PRINT "*";: NEXT j: PRINT
 320 INK 7: FOR j = 1 TO t6: PRINT "*";: NEXT j: PRINT
