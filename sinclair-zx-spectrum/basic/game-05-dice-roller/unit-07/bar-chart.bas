 ...
 250 NEXT i
 260 PRINT AT 9, 0
 270 FOR j = 1 TO t1: PRINT "*";: NEXT j: PRINT
 280 FOR j = 1 TO t2: PRINT "*";: NEXT j: PRINT
 290 FOR j = 1 TO t3: PRINT "*";: NEXT j: PRINT
 300 FOR j = 1 TO t4: PRINT "*";: NEXT j: PRINT
 310 FOR j = 1 TO t5: PRINT "*";: NEXT j: PRINT
 320 FOR j = 1 TO t6: PRINT "*";: NEXT j: PRINT
