...
920 IF t = 1 AND b(q, p) <> 1 THEN PRINT AT 15, 1; INK 2; "Not your piece      ": GO TO 854
930 IF t = 2 AND b(q, p) <> 2 THEN PRINT AT 15, 1; INK 2; "Not your piece      ": GO TO 854
940 RETURN
950 REM === check move ===
955 LET j = 0
...
980 IF t = 1 AND v < q THEN PRINT AT 15, 1; INK 2; "Must move forward   ": GO TO 854
990 IF t = 2 AND v > q THEN PRINT AT 15, 1; INK 2; "Must move forward   ": GO TO 854
995 RETURN
1000 REM === make move ===
...
1055 IF j = 0 THEN GO TO 1070
1056 LET w = (q + v) / 2: LET x = (p + u) / 2
1057 LET b(w, x) = 0
1058 PRINT AT w + 2, x * 2 + 2; PAPER 0; " "
1059 BEEP 0.1, 5
1062 IF t = 1 THEN LET g = g + 1: GO TO 1070
1064 LET h = h + 1
1070 BEEP 0.05, 10
1080 IF t = 1 THEN LET t = 2: RETURN
1085 LET t = 1
1090 RETURN
...
1140 IF t = 1 AND b(w, x) <> 2 THEN PRINT AT 15, 1; INK 2; "Can only jump enemy ": GO TO 854
1150 IF t = 2 AND b(w, x) <> 1 THEN PRINT AT 15, 1; INK 2; "Can only jump enemy ": GO TO 854
1160 IF t = 1 AND v < q THEN PRINT AT 15, 1; INK 2; "Must jump forward   ": GO TO 854
1170 IF t = 2 AND v > q THEN PRINT AT 15, 1; INK 2; "Must jump forward   ": GO TO 854
1180 LET j = 1
1190 RETURN
