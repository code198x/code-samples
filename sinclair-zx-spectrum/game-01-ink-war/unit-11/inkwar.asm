; ============================================================================
; INK WAR - Unit 11: Defensive AI
; ============================================================================
; AI now considers both offense and defense. Scores cells by:
; - Adjacent AI cells (expansion) + Adjacent human cells (blocking)
; Blocks human territory growth while still building its own.
;
