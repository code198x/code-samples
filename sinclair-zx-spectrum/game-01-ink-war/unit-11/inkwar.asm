;──────────────────────────────────────────────────────────────
; INK WAR - Unit 11 sample (Sound Effects)
; Builds on Unit 10: scoring/win/restart. Adds simple beeper SFX
; for move, claim, and win. Uses ROM beeper routine at 949.
;──────────────────────────────────────────────────────────────
...
;------------------------------------------------------------
; Beeper SFX (uses ROM BEEP routine at 949)
;------------------------------------------------------------
sfx_move:
            ld bc,20
            call BEEP
