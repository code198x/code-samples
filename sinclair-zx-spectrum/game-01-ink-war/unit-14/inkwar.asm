;──────────────────────────────────────────────────────────────
; INK WAR - Unit 14 sample (Difficulty select)
; Builds on Unit 13 hotseat by adding AI play with selectable difficulty.
; Title screen lets you pick Easy/Normal/Hard and choose AI or 2P hotseat.
; AI uses a neighbour-based heuristic with a per-level thinking delay.
;──────────────────────────────────────────────────────────────
