; ============================================================================
; INK WAR - Unit 20: Title Screen Animation
; ============================================================================
; The title screen now features colour cycling on the "INK WAR" title
; for a more professional, eye-catching first impression.
;
...
msg_version:    defb    "PHASE 2 V0.4", 0
