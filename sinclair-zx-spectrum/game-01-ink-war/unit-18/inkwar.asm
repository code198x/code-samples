; ============================================================================
; INK WAR - Unit 18: Cursor Animation
; ============================================================================
; The cursor now pulses through colour/brightness states for better
; visibility and a more polished, engaging visual experience.
;
...
msg_version:    defb    "PHASE 2 V0.2", 0
