; ============================================================================
; INK WAR - Unit 23: Board Size Variation
; ============================================================================
; A simple beeper melody plays on the title screen, creating atmosphere
; and making the game feel more complete.
;
...
msg_version:    defb    "PHASE\ 2\ V0\.7", 0
