; ============================================================================
; INK WAR - Unit 19: Claim Animation
; ============================================================================
; When a cell is claimed, it flashes white briefly before settling to
; the player's colour. This creates more satisfying feedback.
;
...
msg_version:    defb    "PHASE 2 V0.3", 0
