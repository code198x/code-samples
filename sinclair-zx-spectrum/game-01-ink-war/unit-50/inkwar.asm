; ============================================================================
; INK WAR - Unit 50: Memory Optimisation
; ============================================================================
; Reduce memory usage by removing unused code and compressing data.
; All Phase 3 features and polish remain available.
;
...
msg_version:    defb    "PHASE 4 V0.2", 0
