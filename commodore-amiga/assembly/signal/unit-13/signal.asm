...
; Unit 13: Timer
;
; Time pressure creates urgency. This unit adds a 60-second countdown timer.
; Run out of time and you die. Reach home faster to earn bonus points.
;==============================================================================
...
start:
            ...
            ; Display score and timer after all DMA enabled
            bsr     display_score
            bsr     display_timer
