...
.nulls:
            ...
            move.w  #$c000,CLXCON(a5)   ; ENSP5+ENSP7: odd sprites sit OUT
                                        ;   of collision unless invited —
                                        ;   the bale and the duck both
                                        ;   need their bits set
...
drivelanes:
            lea     vehtab,a2
            moveq   #5-1,d6             ; Three vehicles, two ferries
.veh:
...
.watch:
            ...
            and.w   #$0200,d0           ; Bit 9, the tractor: nothing —
            bne.s   .squashed           ;   she meets up there is kind
            move.w  contacts,d0
...
duckx:      dc.w    300                 ; The duck, paddling west
