;──────────────────────────────────────────────────────────────
; HOP - Unit 10 sample (Death animations and respawn)
; Builds on Unit 9 visuals: bitplane, frog sprite, traffic/rivers/logs.
; Adds death state with simple colour flash and respawn after delay.
; Lives are not tracked yet (unit 12); death_cause is set by collisions.
;──────────────────────────────────────────────────────────────
...
check_collisions:
            ...
            rts
.road_check:
            ; if frog_x in region of a car => death
            ; placeholder: if x between 40-80
            move.w  frog_x,d0
            cmpi.w  #40,d0
            blt.s   .safe
            cmpi.w  #80,d0
            ...
            move.b  #DEAD_ACTIVE,death_state
...
update_death:
            tst.b   death_state
            beq.s   .done
            ; flash background color as simple animation
            lea     CUSTOM,a5
