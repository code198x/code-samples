;──────────────────────────────────────────────────────────────
; HOP - Unit 15 sample (Title screen)
; Builds on Unit 14 SFX. Adds a simple blocky logo, colour bars, and a
; clearer start prompt on the title screen (mouse click to play).
;──────────────────────────────────────────────────────────────
...
draw_title_screen:
            bsr     clear_bpl
            lea     CUSTOM,a5
            move.w  #$000,$0180(a5)    ; background
            move.w  #$0f60,$0182(a5)   ; ink for title blocks
...
; simple rectangle fill for 1bpp title art
; d0=x (pixels, multiple of 8), d1=y, d2=width (pixels, multiple of 8), d3=height
fill_rect:
            movem.l d0-d5/a0,-(sp)
            lsr.w   #3,d0
            lsr.w   #3,d2
