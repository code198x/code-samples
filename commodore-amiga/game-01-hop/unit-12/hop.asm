;──────────────────────────────────────────────────────────────
; HOP - Unit 12 sample (Lives + Game Over + Reset)
; Builds on Unit 11 SFX and death/respawn visuals. Adds lives counter,
; game over state, and restart on mouse click.
;──────────────────────────────────────────────────────────────
...
check_game_over:
            ...
            rts
.maybe_restart:
            ; wait for mouse button to restart
            btst    #6,$bfe001
            bne.s   .exit
            bsr     init_state
.exit:      rts
