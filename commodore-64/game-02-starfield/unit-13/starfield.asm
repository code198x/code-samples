;═══════════════════════════════════════════════════════════════════════════════
; STARFIELD - Unit 13: Enemy Destruction
; A space shooter for the Commodore 64
;
; This unit adds proper enemy destruction with respawn after a delay.
; Enemy disappears when hit and reappears after a timer.
;
...
; Respawn timing
RESPAWN_TIME = 120              ; 2 seconds at 60fps
...
update_respawn:
            ...
            ; Timer reached zero - respawn enemy
            jsr respawn_enemy
...
!zone respawn_enemy
respawn_enemy:
            ; Reset position to top centre
            lda #172
            sta enemy_x
            lda #60
            sta enemy_y

            ; Reset colour to green
            lda #COL_GREEN
            sta SPRITE_COL + 5
