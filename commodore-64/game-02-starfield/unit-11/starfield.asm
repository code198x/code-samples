;═══════════════════════════════════════════════════════════════════════════════
; STARFIELD - Unit 11: Enemy Movement
; A space shooter for the Commodore 64
;
; This unit adds enemy movement - the alien patrols horizontally,
...
;───────────────────────────────────────────────────────────────────────────────
; Update Enemy - Horizontal patrol movement
;───────────────────────────────────────────────────────────────────────────────
!zone update_enemy
update_enemy:
            ...
            bcc .check_left
            ; Reverse to left
            lda #256 - ENEMY_SPEED      ; -1 in two's complement
            sta enemy_dir
            jmp .done
