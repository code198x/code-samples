; ============================================================================
; SID SYMPHONY - Unit 42: Advanced SID - Filters
; ============================================================================
; The SID filter transforms how notes sound based on gameplay state.
; Perfect hits trigger bright filter sweeps, high combos lift the overall
; brightness, and low health muffles the sound—audio that tells the story.
;
; New features:
; - Filter sweep on perfect hits (brief brightening effect)
; - Filter brightness tied to combo multiplier (higher = brighter)
; - Muffled sound at low health (tension/danger feedback)
; - Dynamic audio that responds to every game state
;
