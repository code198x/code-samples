; ============================================================================
; SID SYMPHONY - Unit 62: Bug Hunt and Edge Cases
; ============================================================================
; This unit covers systematic bug hunting - finding and fixing issues that
; only appear in edge cases or unusual player behaviour.
;
; CONCEPTS COVERED:
...
; - Discuss common C64 game bugs
; - Present defensive coding patterns
;
