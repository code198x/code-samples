; ============================================================================
; SID SYMPHONY - Unit 53: Advanced SID - Multi-Speed
; ============================================================================
; This unit explains multi-speed SID playback - updating the SID chip multiple
; times per frame for richer, more detailed sound. We document the concepts
; while keeping our implementation at standard 1x speed for simplicity.
;
; CONCEPTS COVERED:
; - Standard vs multi-speed SID playback
; - Why faster updates produce better sound
; - Common multi-speed formats (2x, 4x, 8x)
; - Trade-offs between audio quality and CPU usage
;
; OUR APPROACH:
; - 1x speed (50Hz on PAL) - standard game music quality
; - Sufficient for rhythm game feedback
; - Leaves CPU headroom for gameplay
;
