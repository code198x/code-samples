; ============================================================================
; SID SYMPHONY - Unit 28: Endless Mode
; ============================================================================
; Adding Endless Mode - a survival challenge where songs loop continuously
; until health depletes. Score accumulates across loops, testing endurance.
; Press E on the menu to toggle Endless Mode on/off.
;
; New concepts: Game modes, song looping, loop counter, survival mechanics
;
