; ============================================================================
; SID SYMPHONY - Unit 43: Sound Effects Layer
; ============================================================================
; A complete sound effects inventory for all game states. Victory jingles
; celebrate success, game over stingers mark failure, and every transition
; has audio feedback. The game now has a complete audio identity.
;
; New features:
; - Victory jingle on song completion (short celebratory melody)
; - Game over stinger when health depletes (somber tone)
; - Menu back sound (distinct from forward)
; - Organised sound effects with play_sfx routine
;
