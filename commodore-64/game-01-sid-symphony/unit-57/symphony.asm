; ============================================================================
; SID SYMPHONY - Unit 57: Tape/Disk Optimisation
; ============================================================================
; This unit covers data organisation for faster loading - how professional
; games arranged their data to minimise seek time and maximise throughput.
;
; CONCEPTS COVERED:
; - Disk track layout and seek times
; - Sequential data organisation
; - File interleaving for speed
; - Compression techniques
;
; OUR APPROACH:
; - Game runs from memory (no loading optimisation needed)
; - Educational: understand for physical media distribution
; - Key insight: data layout matters for real hardware
;
