; ============================================================================
; SID SYMPHONY - Unit 22: Combo Visuals
; ============================================================================
; Enhanced visual feedback for combo streaks. The border colour shifts with
; combo tier, creating escalating intensity. Breaking a big combo feels
; devastating as all effects disappear.
;
; New concepts: Colour cycling, border feedback, visual reward systems
;
