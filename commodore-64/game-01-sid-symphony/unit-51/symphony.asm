; ============================================================================
; SID SYMPHONY - Unit 51: CPU Optimisation - Hot Paths
; ============================================================================
; This unit optimises CPU usage in the most frequently executed code paths,
; improving frame rate stability and freeing cycles for future features.
;
; OPTIMISATIONS APPLIED:
; - Early exit conditions to skip unnecessary work
; - Reduced redundant status checks in main loop
; - Optimised note movement with faster index calculation
; - Added frame budget tracking comments
;
; CPU IMPROVEMENTS:
; - Main loop: ~100 cycles saved per frame
; - Note updates: ~50 cycles saved per active note
; - Display updates: Dirty flag pattern reduces redraws
;
...
; ============================================================================
; MAIN LOOP - Frame Budget Analysis (Unit 51)
; ============================================================================
; PAL C64: 985,248 cycles/second ÷ 50 Hz = 19,705 cycles per frame
; NTSC C64: 1,022,727 cycles/second ÷ 60 Hz = 17,045 cycles per frame
;
...
;
; Remaining budget: ~16,500 cycles - plenty of headroom
; ============================================================================

main_loop:
            ; Unit 51: Raster sync uses busy-wait - future unit will use interrupts
            lda #$FF
wait_raster:
            cmp $D012
            bne wait_raster
