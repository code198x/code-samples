; ============================================================================
; SID SYMPHONY - Unit 52: Stable Raster Timing
; ============================================================================
; This unit documents raster timing concepts and prepares the codebase for
; more advanced visual effects. We explain the theory without implementing
; full raster interrupts, keeping the code simple for educational purposes.
;
; CONCEPTS COVERED:
; - VIC-II raster beam and timing
; - Why stable timing matters for visual effects
; - The difference between polling and interrupts
; - When to use each approach
;
; CURRENT APPROACH:
; - Raster polling (simple, sufficient for our needs)
; - Frame sync at line 255 (bottom of visible screen)
; - No visual tearing due to careful update timing
;
