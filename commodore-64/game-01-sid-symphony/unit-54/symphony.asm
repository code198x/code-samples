; ============================================================================
; SID SYMPHONY - Unit 54: Advanced SID - Ring Modulation
; ============================================================================
; This unit explores ring modulation - the SID's ability to multiply waveforms
; together, creating metallic, bell-like tones that define the C64's unique
; sound character.
;
; CONCEPTS COVERED:
; - What ring modulation does mathematically
; - How to enable it on SID voices
; - Creating bell and metallic sounds
; - Combining with other SID features
;
; RING MODULATION BASICS:
; - Voice 1 can ring-mod with Voice 3
; - Voice 2 can ring-mod with Voice 1
; - Voice 3 can ring-mod with Voice 2
; - Set bit 2 of control register ($D404, $D40B, $D412)
;
