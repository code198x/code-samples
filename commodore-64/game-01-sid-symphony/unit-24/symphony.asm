; ============================================================================
; SID SYMPHONY - Unit 24: Song 4 - Syncopation
; ============================================================================
; Adding a fourth song that emphasises off-beats. Notes land between expected
; beats, challenging players' rhythm intuition. A visual beat marker pulses
; on downbeats to help players stay oriented.
;
; New concepts: Syncopation, off-beat patterns, visual beat indicator
;
