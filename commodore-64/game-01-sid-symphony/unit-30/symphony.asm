; ============================================================================
; SID SYMPHONY - Unit 30: Advanced Scoring Mechanics
; ============================================================================
; Adding advanced scoring: perfect streak bonuses, section completion rewards,
; and full combo bonus. Skilled play is now richly rewarded.
;
; New concepts: Streak tracking, milestone bonuses, accuracy rewards
;
