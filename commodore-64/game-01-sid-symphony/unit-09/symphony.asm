...
;
; New features:
; - Track-specific waveforms (Pulse, Sawtooth, Triangle)
; - Tuned ADSR envelopes for punchier sound
; - Filter sweep on hits for brightness
; - Dissonant "bum note" on misses
;──────────────────────────────────────────────────────────────
