; ============================================================================
; SID SYMPHONY - Unit 21: Song 3 - Faster Tempo
; ============================================================================
; Adding a third song at 150 BPM. Faster scroll speed tests reaction time.
; Easy mode on Song 3 feels like Normal on Song 1.
;
; New concepts: Variable tempo support, faster scroll calculation,
;               tempo-based difficulty scaling
;
