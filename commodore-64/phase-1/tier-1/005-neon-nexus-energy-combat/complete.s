; Neon Nexus - Lesson 5 Complete
; Full combat system with multiple bullets and sound
...
draw_bullet:
        ...
        lda #$51        ; Circle character for bullet
        ldy #$00
        sta ($fb),y
        
        ; Calculate color RAM position properly
        lda $fb
        sta $fd
        lda $fc
        clc
...
handle_enemy_hit:
        ...
        ; Clear old enemy position first
        lda enemy_x
        sta player_x
        lda enemy_y
        sta player_y
        ...
        ; Move enemy to new random-ish position
        lda random_seed
        and #$1f        ; 0-31
        clc
        adc #4          ; 4-35
...
update_enemy:
        ...
        ; Improved AI: move toward player with some randomness
        lda random_seed
        and #$03
        bne normal_chase   ; 75% chance of normal chase
        
        ; 25% chance of random movement
        lda random_seed
        lsr
        lsr
        and #$03
...
execute_move:
        ; Execute movement based on A register
...
; Data tables
random_moves:   !byte 0, 1, 2, 3    ; Left, Right, Up, Down
