; ============================================================================
; SID SYMPHONY - Unit 32: Phase 2 Complete
; ============================================================================
; Phase 2 completion - all features integrated, tested, and polished.
; Six songs, three difficulties, endless mode, practice mode, grades, streaks.
;
; Phase 2 delivers a feature-complete rhythm game ready for visual polish.
;
...
draw_press_done:
            ...
            ; Draw version on row 23
            ldx #0
draw_version:
            lda version_text,x
            beq draw_version_done
            sta SCREEN + (23 * 40) + 14,x
            lda #11             ; Dark grey
            sta COLRAM + (23 * 40) + 14,x
            inx
            jmp draw_version
draw_version_done:
