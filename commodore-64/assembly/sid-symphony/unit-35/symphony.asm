; ============================================================================
; SID SYMPHONY - Unit 35: Attract Mode
; ============================================================================
; When the title screen sits idle, the game demonstrates itself. This creates
; a "arcade cabinet" feel where passersby can see the game in action.
;
; New features:
; - Idle timer counts frames without input
; - After 5 seconds idle, switches to attract/demo mode
; - Demo plays through Song 1 automatically
; - "PRESS ANY KEY" overlay appears
; - Any input returns to normal title screen
;
