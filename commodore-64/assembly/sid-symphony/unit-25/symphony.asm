; ============================================================================
; SID SYMPHONY - Unit 25: High Score Persistence
; ============================================================================
; Adding high score tracking that persists across plays within a session.
; Each song/difficulty combination tracks its own high score. Beating a high
; score triggers a "NEW HIGH SCORE" celebration.
;
; New concepts: Score comparison, multi-byte arithmetic, high score tables
;
