; ============================================================================
; SID SYMPHONY - Unit 55: Sprite Multiplexing Introduction
; ============================================================================
; This unit introduces sprite multiplexing - displaying more than 8 sprites
; by rapidly repositioning them during screen drawing. We explain the concept
; without implementing it, as our character-based game doesn't need sprites.
;
; CONCEPTS COVERED:
; - VIC-II sprite hardware limits (8 sprites)
; - How multiplexing overcomes the limit
; - Raster interrupt timing for sprite changes
; - When multiplexing is worth the complexity
;
; OUR APPROACH:
; - Character-based graphics (no sprites used)
; - Simpler, no multiplexing needed
; - Educational: understand the technique for future projects
;
