; ============================================================================
; SID SYMPHONY - Unit 49: Code Review and Architecture
; ============================================================================
; This unit reviews the codebase architecture developed over 48 units,
; documenting the structure, memory layout, and code organization to
; prepare for optimization in subsequent units.
;
; CODE STATISTICS:
; - Total lines: ~8,750 (including comments and data)
; - Compiled size: ~13KB PRG file
; - Zero page usage: $02-$4E (77 bytes)
; - Game states: 7 (Title, Menu, Playing, Results, Game Over, Attract, Options)
;
; ARCHITECTURE OVERVIEW:
; 1. Constants and Settings (lines 27-275)
; 2. Memory Map Definitions (lines 126-275)
; 3. Main Entry Point and Initialization (lines 454-510)
; 4. Game State Machine - main_loop (lines 511-560)
; 5. State Update Routines (lines 561-2280)
; 6. Game Logic - notes, scoring, health, combo (lines 2281-3500)
; 7. Display Routines - HUD, effects, overlays (lines 3501-5500)
; 8. Audio Routines - SID playback, effects, jingles (lines 5501-6500)
; 9. Input Handling - joystick, keyboard (integrated in update routines)
; 10. Data Tables - songs, graphics, text (lines 7894-8756)
;
