; ============================================================================
; SID SYMPHONY - Unit 36: Hit Zone Animation
; ============================================================================
; The hit zone pulses to the beat, creating visual rhythm that helps players
; time their inputs. This visual feedback makes the game feel more alive.
;
; New features:
; - Hit zone colour pulses brighter on each beat
; - Animation synced to song tempo via beat_pulse variable
; - Smooth fade from bright to normal between beats
; - Visual cue helps players anticipate timing
;
