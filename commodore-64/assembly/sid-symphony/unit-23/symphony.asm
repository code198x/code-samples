; ============================================================================
; SID SYMPHONY - Unit 23: Practice Mode
; ============================================================================
; A no-fail mode for learning songs. Health never depletes, allowing players
; to practice difficult sections without frustration. Speed can be adjusted
; to 0.5x, 0.75x, or 1x for learning complex patterns.
;
; New concepts: Game modes, speed scaling, no-fail flag
;
