; ============================================================================
; SID SYMPHONY - Unit 34: Title Screen Animation
; ============================================================================
; Building on Unit 33's professional title screen, this unit adds animation:
; - Logo colour cycling creates a shimmering effect
; - Pulsing "PRESS FIRE" text draws attention
; - Frame counter drives all animations
;
; The title screen now feels alive and inviting.
;
