; ============================================================================
; SID SYMPHONY - Unit 61: Credits Sequence
; ============================================================================
; This unit covers creating a credits sequence - recognising the people who
; made the game and providing a satisfying conclusion to the experience.
;
; CONCEPTS COVERED:
; - Credits scroll implementation
; - Timing and pacing
; - Music selection for credits
; - Hidden content and easter eggs
;
; OUR APPROACH:
; - Explain credits design principles
; - Discuss how to make credits engaging
; - Present hidden content strategies
;
