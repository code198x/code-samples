; ============================================================================
; SID SYMPHONY - Unit 45: High Score Table
; ============================================================================
; The game now features a proper leaderboard with name entry. When players
; beat their previous best, they enter their initials and see their name
; immortalised alongside other top scores.
;
; New features:
; - High score table with top 5 entries per song/difficulty
; - Name entry UI (3 letters with joystick/keyboard)
; - Sorted insertion into leaderboard
; - Formatted table display with rank, name, and score
;
...
; ============================================================================
; END OF SID SYMPHONY - UNIT 45 (HIGH SCORE TABLE)
; ============================================================================
