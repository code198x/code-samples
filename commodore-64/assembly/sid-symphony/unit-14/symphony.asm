; ============================================================================
; SID SYMPHONY - Unit 14: Game Over Screen
; ============================================================================
; Improved game over screen when health depletes. Clear display showing
; failure distinctly from success. Score shown, red colour scheme.
;
