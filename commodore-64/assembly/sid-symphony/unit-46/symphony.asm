; ============================================================================
; SID SYMPHONY - Unit 46: Options Screen
; ============================================================================
; A dedicated options screen provides access to game settings, a sound test
; for previewing all audio, and statistics tracking player performance over
; time. The menu is accessible from the title screen.
;
; New features:
; - Options menu with multiple settings
; - Sound test to preview all sound effects
; - Statistics display (games played, notes hit, best combo)
; - 32-bit counters for lifetime statistics
;
