; ============================================================================
; SID SYMPHONY - Unit 27: Visual Polish
; ============================================================================
; Adding visual polish: screen flash on perfect hits, a pulsing beat marker
; that helps players feel the rhythm, and enhanced feedback effects.
;
; New concepts: Screen effects, beat visualisation, timed colour changes
;
