; ============================================================================
; SID SYMPHONY - Unit 47: Pause Functionality
; ============================================================================
; Players can now pause mid-game, access a pause menu, and resume with a
; countdown. The pause system silences audio, displays an overlay, and offers
; Resume, Restart, or Quit options.
;
; New features:
; - P key pauses during gameplay
; - Pause overlay with menu options
; - 3-2-1 countdown on resume
; - SID audio pause and restore
;
