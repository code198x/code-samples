; ============================================================================
; SID SYMPHONY - Unit 40: Background Visuals
; ============================================================================
; A static black background works, but dynamic colour cycling makes the game
; feel alive. The background subtly shifts through dark colours, with
; intensity increasing as the combo builds.
;
; New features:
; - Subtle background colour cycling during gameplay
; - Colour intensity tied to combo multiplier
; - Smooth transitions that don't distract from notes
