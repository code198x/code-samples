; ============================================================================
; SID SYMPHONY - Unit 20: Note Patterns per Difficulty
; ============================================================================
; Each difficulty level now has different note patterns. Easy has fewer notes
; (only strong beats), Normal is the base pattern, Hard adds off-beat notes.
; Same song, different challenge.
;
; New concepts: Difficulty-variant data, pattern filtering, pattern densification
;
