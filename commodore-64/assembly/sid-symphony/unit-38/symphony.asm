; ============================================================================
; SID SYMPHONY - Unit 38: Good Hit Effects
; ============================================================================
; Good hits deserve positive feedback too, but clearly distinct from perfect.
; This creates visual hierarchy that encourages players to improve timing.
;
; New features:
; - "GOOD" text popup (shorter than "PERFECT!")
; - Different colour scheme (greens/cyans vs whites/yellows)
; - Shorter effect duration (less celebration)
; - Clear visual distinction between hit qualities
;
