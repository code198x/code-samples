; ============================================================================
; SID SYMPHONY - Unit 37: Perfect Hit Effects
; ============================================================================
; When players achieve perfect timing, they deserve celebration. This unit
; adds layered visual effects that reward accuracy and build excitement.
;
; New features:
; - Screen flash on perfect hits (brief white border)
; - Character-based starburst effect at hit position
; - "PERFECT!" text popup that fades quickly
; - Enhanced visual distinction from good/miss hits
;
