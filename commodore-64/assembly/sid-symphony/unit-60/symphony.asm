; ============================================================================
; SID SYMPHONY - Unit 60: Final Song - The Showcase
; ============================================================================
; This unit discusses designing a finale song - the ultimate challenge that
; tests all the skills players have developed throughout the game.
;
; CONCEPTS COVERED:
; - Difficulty curve design
; - Song composition for challenge
; - Rewarding player mastery
; - Boss fight philosophy in rhythm games
;
; OUR APPROACH:
; - Explain finale song design principles
; - Discuss how to challenge without frustrating
